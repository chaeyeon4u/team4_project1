	...
	<div class="footer_cnts2 clearfix">
		<div class="footer">
			<div class="cnts2_left">
				...
				<p class="top_p"><span>(주)한섬</span><span>대표이사 : 김민덕</span><span>서울시 강남구 도산대로 523 한섬빌딩</span><span>TEL 1800-5700</span><span class="bgnone">FAX 02-6078-2856</span></p>
				<p><span>사업자등록번호 120-81-26337</span><span>통신판매업신고번호 강남 제 00826호</span><span>개인정보관리책임자 이정득</span><span class="bgnone">호스팅서비스 : (주) 한섬</span></p>
			...
			<div class="cnts2_right">
					...
					<dl class="family">
						...
						<dd style="">
							<ul>
	                            ...
	                            <li><a href="http://www.hcn.co.kr/main.hcn?method=man_00" target="_blank" onclick="GA_Event('공통','푸터_CNT','FAMILY SITE_현대HCN');">현대HCN<!-- 현대 HCN --></a></li>
				...
				<!-- noticeWrap -->
				<div id="noticeWrap" class="news">
					<div class="controls">
						<a href="javascript:void(0);" class="prev">이전</a>
						<a href="javascript:void(0);" class="next">다음</a>
					</div>
					<div class="list">
						<div class="tlt">NEWS<!-- NEWS --></div>
						<ul class="list_new" style="top: -20px;"><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8802351830812&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">폼스튜디오, 가을 겨울 화보 공개</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8802351798044&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">VR로 즐기는 TOM STYLE</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8802351765276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] TIME 21 FW 디지털 런웨이</a></li><li><a href="/ko/magazine/newsDetailtemplatetype4?newsCode=8802318997276&amp;typeCode=WEB" onclick="GA_Common('news',$(this))">[핸썸TV] TOM &amp; FOURM, 특별함을 더한 가을 니트</a></li></ul>
					</div>
				</div>
				<!-- //noticeWrap -->
				</div>
